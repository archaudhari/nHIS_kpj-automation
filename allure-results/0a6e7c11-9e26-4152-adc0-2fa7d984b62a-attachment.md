...
=========================== logs ===========================
waiting for navigation to "**/PatientDashboard" until "domcontentloaded"
============================================================
```
      ...
      - navigation [ref=e3]:
        - generic [ref=e4]:
          ...
          - list [ref=e8]:
            ...
            - listitem [ref=e11]:
              - generic [ref=e12]: "Last Login : 11/05/2026 01:48:19"
            - listitem [ref=e13]:
              ...
              - generic [ref=e93]:
                - generic [ref=e94]:
                  - generic [ref=e96]:
                    ...
                    - textbox "dd/mm/yyyy" [disabled] [ref=e100]: 10/05/2026
                  - generic [ref=e102]:
...
```ts
  ...
  25 |   await login.login(ENV.USERNAME, ENV.PASSWORD);
  26 | 
  27 |   // ── Step 3: Navigate OP → Registration ──────────────────
  28 |   // Clicks #li0OP > a, waits for submenu, clicks #li1PatientRegistration
  29 |   await op.openRegistration();
> 30 |   await page.waitForURL('**/PatientDashboard', {
     |              ^ Error: page.waitForURL: Test timeout of 100000ms exceeded.
  31 |     waitUntil: 'domcontentloaded',
  32 |   });
  33 | 
  34 | 
  35 |   // ── Step 4: Fill Patient Details ───────────────────────
  36 |   // await registration.fillPatientDetails();
  37 | 
  38 |   // ── Step 5: Fill Address ─────────────────────────────────
  39 |   //await registration.fillAddress();
  40 | 
  41 |   // ── Step 6: Fill Visit Details ───────────────────────────
  42 |   //await registration.fillVisitDetails();
  43 | 
  44 |   // ── Step 8: Save ─────────────────────────────────────────
  45 |   //await registration.clickSave();
  46 | 
  47 |   // ── Step 9: Assert success ───────────────────────────────
  48 |  // await registration.validateSuccess();
  49 | });
  50 | 
```