...
```
Error: locator.waitFor: Error: strict mode violation: locator('select[ng-model="Registration.RaceID"]') resolved to 2 elements:
    1) <select ng-required="true" required="required" ng-model="Registration.RaceID" ng-options="item.value as item.text  for item in drRace" class="form-control input-sm ng-pristine ng-untouched ng-invalid ng-invalid-required">…</select> aka locator('div:nth-child(16) > .form-group > .col-sm-8 > .form-control').first()
    2) <select ng-required="true" required="required" ng-model="Registration.RaceID" ng-options="item.value as item.text  for item in drRace" class="form-control input-sm ng-pristine ng-untouched ng-invalid ng-invalid-required">…</select> aka locator('div:nth-child(2) > .row > div:nth-child(2) > .form-group > .col-sm-8 > .form-control').first()

Call log:
  - waiting for locator('select[ng-model="Registration.RaceID"]') to be visible
      ...
      - navigation [ref=e3]:
        - generic [ref=e4]:
          ...
          - list [ref=e8]:
            ...
            - listitem [ref=e11]:
              - generic [ref=e12]: "Last Login : 15/05/2026 01:52:29"
            - listitem [ref=e13]:
              ...
              - generic [ref=e93]:
                - generic [ref=e94]:
                  - generic [ref=e96]:
                    ...
                    - textbox "dd/mm/yyyy" [disabled] [ref=e100]: 14/05/2026
                  - generic [ref=e102]:
                  ...
                  - generic [ref=e132]:
                    ...
                    - generic [ref=e135]:
                      - combobox [ref=e136]:
                        ...
                        - option "Mrs."
                        - option "Hajjah"
                      - textbox [ref=e137]: PATIENTNGQYQJSMMX
                  - generic [ref=e139]:
...
```ts
  ...
  139 |         await nationalityDropdown.selectOption({ label: targetNationality });
  140 |         
  141 |         // CRITICAL: Force Angular to trigger all 4 background functions
  142 |         await nationalityDropdown.dispatchEvent('change');
  143 |         
  144 |         // Wait 1 full second for the app to fetch the new Race list and update ID requirements
  145 |         await this.page.waitForTimeout(1000); 
  146 | 
  147 |         // 2. SELECT RACE
  148 |         const raceDropdown = this.page.locator('select[ng-model="Registration.RaceID"]');
> 149 |         await raceDropdown.waitFor({ state: 'visible' });
      |                            ^ Error: locator.waitFor: Error: strict mode violation: locator('select[ng-model="Registration.RaceID"]') resolved to 2 elements:
  150 | 
  151 |         // Select the appropriate race based on what the test script passed in
  152 |         await raceDropdown.selectOption({ label: targetRace });
  153 |         
  154 |         // Force Angular to register the race selection
  155 |         await raceDropdown.dispatchEvent('change');
