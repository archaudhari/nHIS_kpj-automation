      ...
      - navigation [ref=e3]:
        - generic [ref=e4]:
          ...
          - list [ref=e8]:
            ...
            - listitem [ref=e11]:
              - generic [ref=e12]: "Last Login : 20/05/2026 01:33:06"
            - listitem [ref=e13]:
...
```ts
  ...
  317 | await encounterDropdown.waitFor({ state: 'visible', timeout: 10000 });
  318 | 
  ...
  338 | await this.page.waitForLoadState('domcontentloaded', { timeout: 10000 });
...
> 343 | await primaryDoctorDropdown.waitFor({ state: 'visible', timeout: 10000 });
      |                             ^ TimeoutError: locator.waitFor: Timeout 10000ms exceeded.
  344 | 
  ...
  375 | await this.page.waitForLoadState('networkidle', { timeout: 10000 });
