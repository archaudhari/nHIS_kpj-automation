...
Call log:
  - waiting for locator('select[ng-model="Visit.EncounterTypeID"]') to be visible
    123 × locator resolved to hidden <select ng-model="Visit.EncounterTypeID" ng-options="item.value as item.text for item in drpEncounterType" class="form-control input-sm validate[required] ng-pristine ng-untouched ng-valid">…</select>
      ...
      - navigation [ref=e3]:
        - generic [ref=e4]:
          ...
          - list [ref=e8]:
            ...
            - listitem [ref=e11]:
              - generic [ref=e12]: "Last Login : 18/05/2026 11:30:49"
            - listitem [ref=e13]:
              ...
              - generic [ref=e93]:
                ...
                - generic [ref=e130]:
                  - generic [ref=e132]:
                    ...
                    - generic [ref=e135]:
                      - combobox [ref=e136]:
                        ...
                        - option "Mrs."
                        - option "Hajjah"
                      - textbox [ref=e137]: PATIENTQBWUXARCAF
                  - generic [ref=e139]:
                  ...
                  - generic [ref=e183]:
                    ...
                    - generic [ref=e186]:
                      - textbox "Year(s)" [disabled] [ref=e187]: "70"
                      - textbox "Month(s)" [disabled] [ref=e188]: "9"
                      - textbox "Day(s)" [disabled] [ref=e189]: "24"
                  - generic [ref=e191]:
                ...
                - generic [ref=e272]:
                  ...
                  - generic [ref=e276]:
                    - generic [ref=e278]:
                      ...
                      - textbox [ref=e281]: No. 80, Jalan Automation Testing
                    - generic [ref=e283]:
                    ...
                    - generic [ref=e313]:
                      ...
                      - generic [ref=e316]:
                        - combobox [ref=e317]:
                          ...
                          - option "60" [selected]
                          - option "91"
                        - textbox "Mobile" [ref=e318]: "125686923"
                    ...
                    - generic [ref=e329]:
                      ...
                      - textbox [ref=e332]: test.patient1779118276775@sancyberhad.com
                - generic [ref=e333]:
                ...
                - generic [ref=e356]:
                  ...
                  - generic [ref=e359]:
                    - table [ref=e361]:
                      ...
                      - rowgroup [ref=e385]:
                        - row " Mr. KIN_AUTOMATION_1291 Malaysian 111107139095 No. 80, Jalan Automation Testing 60123642225 60 Father Kuala Lumpur Wilayah Persekutuan Kuala Lumpur Malaysia 50000" [ref=e386]:
                          - cell "" [ref=e387]:
                            - button "" [ref=e388] [cursor=pointer]:
                              - generic "Delete" [ref=e389]: 
                          - cell "Mr." [ref=e390]
                          - cell "KIN_AUTOMATION_1291" [ref=e391]
                          - cell "Malaysian" [ref=e392]
                          - cell "111107139095" [ref=e393]
                          - cell [ref=e394]
                          - cell "No. 80, Jalan Automation Testing" [ref=e395]
                          - cell [ref=e396]
                          - cell "60123642225" [ref=e397]
                          - cell "60" [ref=e398]
                    ...
                    - generic [ref=e429]:
                      ...
                      - generic [ref=e499]:
                        - generic [ref=e500]: TINNumber
                        - textbox "TINNumber" [ref=e502]
                      - generic [ref=e504] [cursor=pointer]:
                        - checkbox "Same As Patient Address" [ref=e505]
                        - text: Same As Patient Address
                      - generic [ref=e507]:
                        - generic [ref=e508]: Address Line 1 *
                        - textbox [ref=e510]
                      - generic [ref=e512]:
                        - generic [ref=e513]: Address Line 2
                        - textbox [ref=e515]
                      - generic [ref=e517]:
                        - generic [ref=e518]: Address Line 3
                        - textbox [ref=e520]
                      - generic [ref=e522]:
                        - generic [ref=e523]: Postcode
                        - textbox [ref=e525]
                      - generic [ref=e527]:
                        - generic [ref=e528]: City / District
                        - combobox [ref=e530]:
                          - option "--Select--" [selected]
                          - option "Kuala Lumpur"
                          - option "Sungai Besi"
                      - generic [ref=e532]:
                        - generic [ref=e533]: State*
                        - combobox [ref=e535]:
                          - option "--Select--" [selected]
                          - option "Johor"
                          - option "Kedah"
                      ...
                      - generic [ref=e537]:
                        ...
                        - combobox [ref=e540]:
                          ...
                          - option "Zimbabwe"
                      - generic [ref=e542]:
                        - generic [ref=e543]: Remarks
                        - textbox [ref=e545]
                  - generic [ref=e546]:
                    - button "Add" [ref=e547] [cursor=pointer]
                    - button "Modify" [disabled] [ref=e548]
                    - button "Cancel" [ref=e549] [cursor=pointer]
        - generic [ref=e550]:
          - tab "Payor Information" [ref=e551]:
            - button "Payor Information" [ref=e552] [cursor=pointer]
          - text:    
        - text:  
      - generic [ref=e553]:
        - tab "Visit Information" [ref=e554]:
          - button "Visit Information" [expanded] [ref=e555] [cursor=pointer]
        - text:  
        - generic [ref=e556]:
          - generic [ref=e557]:
            - generic [ref=e560] [cursor=pointer]:
              - checkbox "Register Only" [ref=e561]
              - text: Register Only
            - generic [ref=e564] [cursor=pointer]:
              - checkbox "Charges Only" [checked] [ref=e565]
              - text: Charges Only
          - generic [ref=e567]:
            - generic [ref=e568]:
              - generic [ref=e570]:
                - generic [ref=e571]: Sign
              ...
              - text: Credit
            - generic [ref=e581]:
              - button "Consent" [ref=e582] [cursor=pointer]
              - button "Patient History" [disabled] [ref=e583]
              - button "Save" [ref=e584] [cursor=pointer]
              - button "Clear" [ref=e585] [cursor=pointer]
        - text:  
  - textbox [ref=e587]
...
```ts
  ...
  256 |     // =====================================================================
  257 |     // =====================================================================
  258 | // ADD THIS MISSING METHOD (called in the spec but doesn't exist)
  259 | // =====================================================================
  260 | async openVisitInformationSection() {
  261 |     // Click the "Visit Information" tab/section header to expand it
  262 |     const visitTab = this.page.locator('a[href="#visitInfo"], [ng-click*="visit"], .visit-info-tab').first();
  263 |     
  264 |     // Fallback: try by visible text if the above selector doesn't match your HTML
  265 |     const visitTabByText = this.page.getByRole('link', { name: /visit information/i })
  266 |         .or(this.page.getByRole('tab', { name: /visit information/i }));
  267 | 
  268 |     try {
  269 |         await visitTab.waitFor({ state: 'visible', timeout: 3000 });
  270 |         await visitTab.click();
  271 |     } catch {
  272 |         await visitTabByText.first().click();
  273 |     }
  274 | 
  275 |     await this.page.waitForTimeout(800); // Allow the section to expand/render
  276 | }
  277 | 
  278 | // =====================================================================
  279 | // FIXED METHOD: fillVisitInformation
  280 | // =====================================================================
  281 | async fillVisitInformation(
  282 |     encounterType: string,
  283 |     department: string,
  284 |     admissionSource: string,
  285 |     targetVisitType: string
  286 | ) {
  287 |     // 1. Encounter Type
  288 |     const encounterDropdown = this.page.locator('select[ng-model="Visit.EncounterTypeID"]');
> 289 |     await encounterDropdown.waitFor({ state: 'visible' });
      |                             ^ Error: locator.waitFor: Test timeout of 100000ms exceeded.
  290 |     await encounterDropdown.selectOption({ label: encounterType });
  291 |     await encounterDropdown.dispatchEvent('change');
  292 |     await this.page.waitForTimeout(500);
  293 | 
  294 |     // 2. Department
  295 |     const departmentDropdown = this.page.locator('select[ng-model="Visit.DepartmentID"]');
  296 |     await departmentDropdown.waitFor({ state: 'visible' });
  297 |     await departmentDropdown.selectOption({ label: department });
  298 |     await departmentDropdown.dispatchEvent('change');
  299 | 
  300 |     // Wait for the Doctor dropdown to populate after department selection
  301 |     const doctorDropdown = this.page.locator('select[ng-model="Visit.DoctorID"]').first();
  302 |     await expect.poll(
  303 |         async () => await doctorDropdown.locator('option').count(),
  304 |         { timeout: 8000, message: 'Doctor dropdown did not populate after department selection' }
  305 |     ).toBeGreaterThan(1);
  306 | 
  307 |     // =====================================================================
  308 |     // SAFE APPROACH: Extract all doctor options into memory FIRST
  309 |     // to prevent stale element errors during Angular re-renders
  310 |     // =====================================================================
  311 |     const doctorOptionsCount = await doctorDropdown.locator('option').count();
  312 |     const availableDoctors: { name: string; value: string }[] = [];
  313 | 
  314 |     for (let i = 1; i < doctorOptionsCount; i++) {
  315 |         const option = doctorDropdown.locator('option').nth(i);
  316 |         const name = await option.innerText();
  317 |         const value = await option.getAttribute('value');
  318 |         if (value) {
  319 |             availableDoctors.push({ name: name.trim(), value });
  320 |         }
  321 |     }
  322 | 
  323 |     console.log(`Found ${availableDoctors.length} doctor(s) in "${department}"`);
  324 | 
  325 |     // 3. Admission Source — fill BEFORE entering the doctor loop
  326 |     //    (does not depend on doctor selection)
  327 |     const sourceDropdown = this.page.locator('select[ng-model="Visit.PatientSourceID"]');
  328 |     await sourceDropdown.waitFor({ state: 'visible' });
  329 |     await sourceDropdown.selectOption({ label: admissionSource });
  330 |     await sourceDropdown.dispatchEvent('change');
  331 |     await this.page.waitForTimeout(500);
  332 | 
  333 |     // 4. DOCTOR + VISIT TYPE SMART LOOP
  334 |     let foundWorkingDoctor = false;
  335 |     const visitTypeDropdown = this.page.locator('select[ng-model="Visit.VisitType"]').first();
  336 | 
  337 |     for (const doctor of availableDoctors) {
  338 |         console.log(`Checking Doctor: ${doctor.name}...`);
  339 | 
  340 |         // Select doctor by Angular value (stale-element safe)
  341 |         await doctorDropdown.selectOption({ value: doctor.value }, { force: true });
  342 |         await doctorDropdown.dispatchEvent('change');
  343 | 
  344 |         try {
  345 |             // ✅ BUG FIX: Poll VISIT TYPE dropdown (not doctorDropdown) for options
  346 |             await expect.poll(
  347 |                 async () => await visitTypeDropdown.locator('option').count(),
  348 |                 { timeout: 4000 }
  349 |             ).toBeGreaterThan(1);
  350 | 
  351 |             const availableVisitTypes = await visitTypeDropdown.locator('option').allInnerTexts();
  352 |             const cleanVisitTypes = availableVisitTypes.map(v => v.trim());
  353 | 
  354 |             if (cleanVisitTypes.includes(targetVisitType)) {
  355 |                 console.log(`✅ "${doctor.name}" supports Visit Type: "${targetVisitType}"`);
  356 | 
  357 |                 await visitTypeDropdown.selectOption({ label: targetVisitType }, { force: true });
  358 |                 await visitTypeDropdown.dispatchEvent('change');
  359 |                 await this.page.waitForTimeout(300);
  360 | 
  361 |                 foundWorkingDoctor = true;
  362 |                 break; // Stop as soon as we find a working doctor
  363 |             } else {
  364 |                 console.log(`❌ "${targetVisitType}" not available for "${doctor.name}". Trying next...`);
  365 |             }
  366 |         } catch {
  367 |             console.log(`❌ Visit Type stayed empty for "${doctor.name}". Trying next...`);
  368 |         }
  369 |     }
  370 | 
  371 |     // 5. FAIL-SAFE
  372 |     if (!foundWorkingDoctor) {
  373 |         throw new Error(
  374 |             `CRITICAL: No doctor in "${department}" supports the "${targetVisitType}" visit type.`
  375 |         );
  376 |     }
  377 | 
  378 |     await this.page.waitForTimeout(500);
  379 | 
  380 |     // 6. Queue Number (after doctor + visit type confirmed)
  381 |     const queueInput = this.page.locator('input[ng-model="Visit.TokenNo"]');
  382 |     await expect(queueInput).toBeEnabled({ timeout: 5000 });
  383 | 
  384 |     const randomQueue = Math.floor(100 + Math.random() * 900).toString();
  385 |     await queueInput.fill(randomQueue);
  386 |     await this.page.locator('body').click();
