      ...
      - navigation [ref=e3]:
        - generic [ref=e4]:
          ...
          - list [ref=e8]:
            ...
            - listitem [ref=e11]:
              - generic [ref=e12]: "Last Login : 18/05/2026 11:56:05"
            - listitem [ref=e13]:
...
```ts
  ...
  287 |         await expect.poll(async () => await doctorDropdown.locator('option').count(), { timeout: 5000 }).toBeGreaterThan(1);
  288 |         
